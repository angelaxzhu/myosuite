...
def main():
    ...
    model = SAC('MlpPolicy', envs, learning_rate=LR,  buffer_size=100000, verbose=0,  tensorboard_log=f"runs/{time_now}")

    obs_callback = TensorboardCallback()
    callback = CallbackList([eval_callback, WandbCallback(gradient_save_freq=1000)])#, obs_callback])
